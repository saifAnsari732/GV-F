...
const getBaseUrl = () => {
  ...
  if (typeof window === 'undefined') {
    return process.env.NEXT_PUBLIC_API_URL?.replace('localhost', '127.0.0.1') || "https://gv-backend-nojn.onrender.com";
  }
  // If running in the browser, use the standard NEXT_PUBLIC_API_URL (which uses localhost, passing CORS)
  return process.env.NEXT_PUBLIC_API_URL || "https://gv-backend-nojn.onrender.com";
};
