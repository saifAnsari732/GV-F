    ...
    <>
      ...
      {state === 'copied' && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 z-[9999] animate-bounce-in">
          <div className="bg-gray-50 border border-emerald-500/40 text-gray-900 px-5 py-3 rounded-2xl shadow-2xl flex items-start gap-3 max-w-sm">
            ...
            <div>
              ...
              <p className="text-xs text-gray-600 mt-0.5">
                Google Review khulega — bas <strong className="text-gray-900">Paste</strong> karo aur Submit!
              </p>
            </div>
          </div>
        </div>
