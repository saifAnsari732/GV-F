...
const JobDetail = () => {
  ...
  if (error) return (
    <div className={pageCls}>
      ...
      <div className="flex flex-col items-center justify-center min-h-[70vh] gap-3.5 text-center relative z-10">
        ...
        <h3 className="font-['Syne',sans-serif] text-[1.4rem] text-gray-900">Something went wrong</h3>
        <p className="text-gray-600">{error}</p>
        <button onClick={()=>navigate('/jobs')}
          className="px-7 py-3 rounded-xl text-gray-900 font-semibold text-[15px] border-none cursor-pointer transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_8px_20px_rgba(0,212,255,0.3)]"
  ...
  if (!job) return (
    <div className={pageCls}>
      {BG_MESH}
      <div className="flex flex-col items-center justify-center min-h-[70vh] gap-3.5 relative z-10">
        <h3 className="font-['Syne',sans-serif] text-[1.4rem] text-gray-900">Job not found</h3>
        <button onClick={()=>navigate('/jobs')}
          className="px-7 py-3 rounded-xl text-gray-900 font-semibold text-[15px] border-none cursor-pointer transition-all duration-300 hover:-translate-y-0.5"
          style={{background:'linear-gradient(135deg,#00D4FF,#7C3AED)'}}>← Back to Jobs</button>
      </div>
    </div>
  );
  ...
  const SectionHead = ({ color='#00D4FF', title }) => (
    <div className="flex items-center gap-3 mb-5">
      ...
      <h3 className="font-['Syne',sans-serif] text-[1.2rem] font-extrabold text-gray-900 m-0">{title}</h3>
    </div>
  );
        ...
        <div className="bg-white border border-gray-200 shadow-sm rounded-3xl overflow-hidden mb-6">
          ...
          <div className="flex flex-wrap justify-between items-start gap-6 px-10 py-9 max-[900px]:px-6 max-[900px]:py-7">
            ...
            <div className="flex-1 min-w-[280px]">
              ...
              <h1 className="font-['Syne',sans-serif] text-[clamp(1.7rem,4vw,3rem)] font-extrabold leading-[1.1] text-gray-900 mb-3">
                {job.title}
              </h1>
              <div className="flex flex-wrap items-center gap-2.5 mb-[22px]">
                ...
                <span className="inline-flex items-center gap-[5px] text-[0.9rem] text-gray-600">
            ...
            <div className="shrink-0 pt-1">
              <div className="flex items-center gap-3.5 bg-gray-50 border border-gray-200 rounded-2xl px-5 py-4">
                ...
                <div>
                  ...
                  <div className="font-['Syne',sans-serif] text-[0.95rem] font-bold text-gray-900">
        ...
        <div className="grid grid-cols-[1fr_320px] max-[900px]:grid-cols-1 gap-[22px] items-start">
          ...
          <div className="flex flex-col gap-[18px]">
            ...
            <div className={sectionCls}>
              ...
              <p className="text-[0.97rem] leading-[1.85] text-gray-600 whitespace-pre-line">{job.description}</p>
            </div>
            ...
            {job.benefits && (
              <div className={sectionCls}>
                ...
                <p className="text-[0.97rem] leading-[1.85] text-gray-600 whitespace-pre-line">{job.benefits}</p>
              </div>
            )}
          ...
          <div className="flex flex-col gap-[18px] sticky top-6 max-[900px]:static max-[900px]:order-first">
            ...
            <div className="bg-white border border-gray-200 shadow-sm rounded-[20px] overflow-hidden">
              ...
              <div className="px-[26px] max-sm:px-[18px]">
                ...
                <p className="text-[0.88rem] text-gray-600 leading-[1.6] mb-[22px]">
              ...
              {[
                ...
                <div key={i} className="flex items-center gap-3.5 py-2.5 border-b border-gray-100 last:border-b-0 last:pb-0">
                  ...
                  <div>
                    ...
                    <div className="text-[0.92rem] font-semibold text-gray-900">{item.value}</div>
                  </div>
                </div>
              ))}
            </div>
